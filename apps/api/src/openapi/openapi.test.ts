...
describe("OpenAPI spec generation", () => {
  ...
  // cookieAuth scheme + /api/health typed-200 property ownership lives in
  // openapi.structural.test.ts (same claims, named-failure assertions);
  // `api:openapi:check` byte-parity alone would bless their silent removal.
});
