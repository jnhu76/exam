...
const zhCN = {
  ...
  admin: {
    ...
    users: {
      ...
      teacherCourses: {
        ...
        revokeBtn: "撤销",
        noChange: "该课程已在授课列表中",
        loadFailed: "加载课程分配失败，请稍后重试",
        assignFailed: "分配课程失败，请稍后重试",
        revokeFailed: "撤销课程分配失败，请稍后重试",
        inactiveTarget: "该账号已停用，无法新增分配；仍可查看和撤销已有分配。",
        optionsUnavailable: "课程列表暂不可用，已有分配不受影响。",
        optionsEmpty: "没有符合条件的课程。",
      },
      graderExams: {
        openBtn: "评卷考试",
        ...
        revokeBtn: "撤销",
        noChange: "该考试已在评卷列表中",
        loadFailed: "加载考试分配失败，请稍后重试",
        assignFailed: "分配考试失败，请稍后重试",
        revokeFailed: "撤销考试分配失败，请稍后重试",
        inactiveTarget: "该账号已停用，无法新增分配；仍可查看和撤销已有分配。",
        optionsUnavailable: "考试列表暂不可用，已有分配不受影响。",
        optionsEmpty: "没有符合条件的考试。",
      },
      invitations: {
        title: "成员邀请",
    ...
    recoveryIncident: {
      ...
      // Keys are exactly the IncidentEventType domain values (ADR-014 §3) —
      // the timeline renders `eventType.${e.eventType}` from the wire, so a
      // missing key would surface as a raw i18n key to the operator.
      eventType: {
        incident_created: "事件创建",
        investigation_started: "开始调查",
        note_added: "添加备注",
        severity_changed: "修改严重程度",
        incident_resolved: "解决事件",
        incident_dismissed: "驳回事件",
        action_linked: "关联操作记录",
        attempt_linked: "关联答题",
        interruption_linked: "关联中断证据",
      },
      policy: {
        strict: "严格",
        bounded_grace: "宽限",
    ...
    recoveryOps: {
      ...
      actions: {
        ...
        linkAction: "关联操作记录",
        linkActionDone: "已关联操作记录",
        linkInterruption: "关联中断证据",
        linkInterruptionDone: "已关联中断证据",
        linkAttempt: "关联答题",
        linkAttemptDone: "已关联答题",
      },
      ...
      actionIdLabel: "操作记录 ID",
      actionIdRequired: "请输入操作记录 ID",
      interruptionIdLabel: "中断记录 ID",
      interruptionIdRequired: "请输入中断记录 ID",
      linkActionDescription: "将一条已有的运维操作记录关联到事件 {{id}}。",
      linkInterruptionDescription: "将一条中断证据关联到事件 {{id}}。",
    ...
    proctorRecovery: {
      ...
      create: {
        title: "创建事件",
        description: "为选中的考试创建一个新的事件。",
        typeLabel: "事件类型",
        typeRequired: "请选择事件类型",
        examLabel: "考试",
        examRequired: "请选择考试",
        descriptionLabel: "事件描述",
        descriptionRequired: "请输入事件描述",
        done: "事件已创建",
      },
    },
    ...
    proctorRecoveryIncident: {
      ...
      snapshotStale: "数据已过时",
      attemptIdLabel: "关联答题 ID",
      attemptIdRequired: "请输入关联答题 ID",
      relationshipLabel: "关联关系",
      relationshipRequired: "请选择关联关系",
      actionTypeLabel: "操作类型",
      actionTypeRequired: "请选择操作类型",
      actionIdLabel: "操作记录 ID",
      actionIdRequired: "请输入操作记录 ID",
  ...
  pageMeta: {
    ...
    dynamic: {
      ...
      examProctor: "监考",
      examMonitor: "考试监控",
      examProfileEdit: "编辑策略模板",
      gradingDetail: "手动评分",
      attemptDetail: "答题详情",
      recoveryIncident: "事件详情",
      recoveryAttempt: "答题操作详情",
      recoveryExam: "考试恢复详情",
      proctorRecoveryIncident: "监考事件详情",
      examPrepare: "考试准备",
      examTake: "正在答题",
      examResult: "考试结果",
    },
