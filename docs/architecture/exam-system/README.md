...
| [incident-authority.md](./incident-authority.md) | TARGET exam incident authority (ADR-014 PROPOSED — NOT IMPLEMENTED): lifecycle, commands, permission matrix, transaction boundaries, data model |
