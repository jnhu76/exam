# d4 freeze — table-header size, frozen at 13px / 20px / 500 (keep as-built)

> Compact canonical copy of the final d4 unblind/freeze record.
>
> - source branch: `research/582-d4-visual-ab-1 (merged via PR #589)`
> - source exact SHA: `b9e3a7458470ecd56d94bef78def1b15ed4a6d8b` (last commit touching the freeze record; the D7 snapshot tree carrying every record is `ff1b535902a8f8ee5d21545450a5774f3c1a46d4`)
> - original path: `docs/research/exam-582-d4-visual-ab-1/06-d4-unblind-freeze.md`
> - retained contact sheets: [`contact-sheets/d4-micro.png`](contact-sheets/d4-micro.png) · [`contact-sheets/d4-macro.png`](contact-sheets/d4-macro.png)
>
