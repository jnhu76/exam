# d3 freeze — primary control family radius, frozen at 6px

> Compact canonical copy of the final d3 unblind/freeze record.
>
> - source branch: `research/582-d3-visual-ab-1 (PR #592, closed unmerged at closeout)`
> - source exact SHA: `e6d683cc8731030fea10632a407df270673d1c83` (last commit touching the freeze record; the D7 snapshot tree carrying every record is `ff1b535902a8f8ee5d21545450a5774f3c1a46d4`)
> - original path: `docs/research/exam-582-d3-visual-ab-1/06-d3-unblind-freeze.md`
> - retained contact sheets: [`contact-sheets/d3-micro.png`](contact-sheets/d3-micro.png) · [`contact-sheets/d3-macro.png`](contact-sheets/d3-macro.png)
>
