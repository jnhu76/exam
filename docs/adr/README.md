...
| [ADR-017](ADR-017-operational-authority-maintainer-boundary.md) | Operational Authority and Maintainer Boundary | PROPOSED (accepted with P7-E1 human review) | Current | none | none |
