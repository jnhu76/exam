...
- the Admin operator time-grant route, permission, atomic audit path, and
  ...
  designed but not implemented (REC-I6-R0 froze it in ADR-014, PROPOSED and
  pending human acceptance; J3 persistence/commands remain blocked on that
...
| REC-I6 / M11 / REC-OPS | REC-I6-R0 incident authority is designed (ADR-014 PROPOSED, pending human acceptance) but NOT IMPLEMENTED; J3, M11, and REC-OPS remain in state/recovery planning and must not be silently declared complete |
