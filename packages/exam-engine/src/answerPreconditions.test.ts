...
describe("EXAM-ANSWER-PRECONDITION-CORRECTIVE-0", () => {
  ...
  // The six former "regression —" persistence rows (accepted save, stale
  // version, idempotent replay, conflicting payload, lastActivityAt stamp,
  // clientSeq history durability) were verbatim duplicates of saveAnswer.test.ts
  // #1–#4 and #8, which is the single composite owner of those contracts.
});
